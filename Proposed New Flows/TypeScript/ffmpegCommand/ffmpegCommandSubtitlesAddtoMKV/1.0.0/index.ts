import { getFileName, getFileAbosluteDir, getContainer } from '../../../../FlowHelpers/1.0.0/fileUtils';
...
const plugin = async (args: IpluginInputArgs): Promise<IpluginOutputArgs> => {
  ...
  const requiredContainer = String('mkv');

  if (getContainer(args.inputFileObj._id) !== requiredContainer) {
    throw new Error('File is not an MKV');
  }
